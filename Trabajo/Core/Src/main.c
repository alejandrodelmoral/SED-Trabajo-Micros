...
/* Private define ------------------------------------------------------------*/
#define MAXC 1 // Numero maximo de caracteres que se transmiten/reciben
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  case 'A':
	  {
		  // Si se manda una 'A' hacer esto
		  break;
	  }
	  case 'B':
	  {
		  // Si se manda una 'B' hacer esto
		  break;
	  }
	  case 'C':
	  {
		  // Si se manda una 'C' hacer esto
		  break;
	  }
	  default:
	  {
